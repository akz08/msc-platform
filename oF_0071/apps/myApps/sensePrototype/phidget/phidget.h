...
//  sensePrototype
//
//  Created by Amer Kamil on 21/06/2012.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//

#ifndef sensePrototype_phidget_h
#define sensePrototype_phidget_h
...
public:
    ...
    {
        // serial number is unique to individual phidget (may have to use two!)
